...
VirtualBox, Windows Server 2022 Evaluation, Active Directory Domain Services, Microsoft Entra ID, Microsoft Entra Connect, PowerShell, Microsoft Graph API, Conditional Access, Privileged Identity Management.
